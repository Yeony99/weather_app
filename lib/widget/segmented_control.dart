...
class SegmentedControl extends StatefulWidget {
  ...
  @override
  _SegmentedControlState createState() => _SegmentedControlState(this.initialSelectionIndex);
}

class _SegmentedControlState extends State<SegmentedControl> {
  _SegmentedControlState(this.selectedIndex);
  int selectedIndex;
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border(
                    // right: BorderSide(color: childBorders[idx]) // 원래 코드
                    right: BorderSide(color: (childBorders[idx])!) // hide right border on last child // null 체크
                ),
              ),
              child: Text(
                segment,
